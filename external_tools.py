...
TOOL_REGISTRY = {
    spec.name: spec for spec in (
        ...
        ToolSpec("naabu", "network", "Bounded TCP port discovery.", True),
        ToolSpec("nmap", "network", "Service and version discovery.", True, True),
        ToolSpec("amass", "recon", "Passive and active attack-surface mapping.", True),
        ToolSpec("gowitness", "recon", "Web screenshot and metadata capture.", True),
        ...
        ToolSpec("gobuster", "discovery", "Directory and DNS content discovery.", True, True),
        ...
        ToolSpec("testssl.sh", "tls", "TLS protocol and cipher assessment.", True),
        ToolSpec("crlfuzz", "validation", "CRLF injection candidate scanning.", True, True),
        ToolSpec("droopescan", "cms", "Drupal and supported CMS fingerprinting.", True, True),
        ToolSpec(
            "kube-hunter",
            "kubernetes",
            "Legacy Kubernetes exposure assessment; upstream recommends Trivy.",
            True,
            True,
        ),
        ToolSpec("trivy", "kubernetes", "Kubernetes and container misconfiguration scanning.", True),
